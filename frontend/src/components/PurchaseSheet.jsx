                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                ...
                                <div className="md:col-span-3 space-y-2">
                                    <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">Propietario</label>
                                    <select
                                            ...
                                            {formData.animales.map((anim, idx) => (
                                                <div key={idx} className="bg-white p-5 rounded-3xl border border-slate-100 space-y-4 relative shadow-sm hover:shadow-md transition-shadow">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div className="space-y-1">
                                                            <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Propietario</label>
                                                            <select
                                            ...
                                            <table className="w-full text-left">
                                                <thead>
                                                    <tr className="text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100">
                                                        ...
                                                        <th className="pb-3 px-2">Propietario</th>
